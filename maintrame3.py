        ...
        with vuetify.VContainer(fluid=True):
            with vuetify.VRow():
                ...
                with vuetify.VCol(cols=3):
                    with vuetify.VCard(title="🛠️ Parameter Analisis", class_="mb-4"):
                        vuetify.VTextField(v_model="latitude_input", label="Latitude", outlined=True, dense=True, hide_details=True, class_="mb-3")
                        vuetify.VTextField(v_model="longitude_input", label="Longitude", outlined=True, dense=True, hide_details=True, class_="mb-3")
                        vuetify.VTextField(v_model="radius_input", label="Radius (interval approx 30m)", type="number", outlined=True, dense=True, hide_details=True, class_="mb-3")
