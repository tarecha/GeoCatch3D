    ...
    with layout.content:
        with vuetify.VContainer(fluid=True):
            with vuetify.VRow():
                ...
                #         vuetify.VSelect(
                #             v_model=("selected_option", None),
                #             items=("items_list", curahhujan.tabelkoefisien),
                #             item_title="text",
                #             item_value="value",
                #             label="Pilih Koefisien C SNI 2415:2016 ",
                #             outlined=True,
                ...
                #         vuetify.VSelect(
                #             v_model=("selected_option_rainfall", None),
                #             items=("rainfall", curahhujan.tabelcurahhujan),
                #             item_title="text",
                #             item_value="value",
                #             label="Pilih Curah Hujan (mm/hari)",
                #             outlined=True,
                ...
                #         html.Div("Estimasi debit puncak: '{{ Qp }}' m³/detik")
                #
                #         html.A(v_bind_href="maps_url", v_text="maps_text", target="_blank",
                #                style="color: blue; text-decoration: underline;")
                #         html.Div("")
