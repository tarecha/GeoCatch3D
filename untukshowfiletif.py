...
show_raster(axs[0,1], cfg.fileFlowAccumulationBreachMDInf, "fileFlowAccumulationBreachMDInf","Upstream contributing cell count",custom_cmapfa1)
show_raster(axs[1,1], cfg.fileExtractstreams, "fileExtractstreams","Upstream contributing cell count",custom_cmapfa1)

show_raster(axs[1,0], cfg.fileStreamslinkidentifier, "fileStreamslinkidentifier","Upstream contributing cell count",custom_cmapfa1)
