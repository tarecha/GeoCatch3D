...
wbt = WhiteboxTools()
blue_red = LinearSegmentedColormap.from_list('blue_red', ['white','yellow'])
...
show_raster(axs[0], cfg.fileFlowAccumulationOri, "a. Flow accumulation from Original DEM","Upstream contributing cell count",custom_cmapfa1)
